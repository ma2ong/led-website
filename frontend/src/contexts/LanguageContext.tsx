...
const translations = {
  zh: {
    ...
    'nav.about': '关于我们',
    'nav.products': '产品中心',
    'nav.products.finePitch': '小间距显示屏',
    'nav.products.outdoor': '户外显示屏',
    'nav.products.rental': '租赁显示屏',
    'nav.products.creative': '创意显示屏',
    'nav.products.allInOne': '会议一体机',
    'nav.products.poster': 'LED广告机',
    'nav.solutions': '解决方案',
    'nav.solutions.government': '政府机构',
    'nav.solutions.sports': '体育场馆',
    'nav.solutions.retail': '商业零售',
    'nav.solutions.conference': '会议展览',
    'nav.solutions.entertainment': '文化娱乐',
    'nav.cases': '成功案例',
    'nav.news': '新闻资讯',
    'nav.support': '技术支持',
    'nav.support.technical': '技术咨询',
    'nav.support.installation': '安装指导',
    'nav.support.maintenance': '维护保养',
    'nav.support.training': '技术培训',
    'nav.support.downloads': '资料下载',
    'nav.contact': '联系我们',
    'nav.inquiry': '询盘',
  ...
  en: {
    ...
    'nav.products.finePitch': 'Fine Pitch LED',
    'nav.products.outdoor': 'Outdoor LED',
    'nav.products.rental': 'Rental LED',
    'nav.products.creative': 'Creative LED',
    'nav.products.allInOne': 'All-in-One',
    'nav.products.poster': 'Poster LED',
    'nav.solutions': 'Solutions',
    'nav.solutions.government': 'Government',
    'nav.solutions.sports': 'Sports Venues',
    'nav.solutions.retail': 'Retail',
    'nav.solutions.conference': 'Conference',
    'nav.solutions.entertainment': 'Entertainment',
    'nav.cases': 'Cases',
    'nav.news': 'News',
    'nav.support': 'Support',
    'nav.support.technical': 'Technical Support',
    'nav.support.installation': 'Installation Guide',
    'nav.support.maintenance': 'Maintenance',
    'nav.support.training': 'Training',
    'nav.support.downloads': 'Downloads',
    'nav.contact': 'Contact',
    'nav.inquiry': 'Inquiry',
